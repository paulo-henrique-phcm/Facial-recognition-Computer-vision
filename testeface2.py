...
def predicts(caminho1, caminho2):
    ...
    img1_representation1 = model.predict(image1)
    img2_representation2 = model.predict(image2)

    img161 = model.predict(image1)
    img162 = model.predict(image2)
    return img1_representation1, img2_representation2, img161, img162
...
def dist_final(caminho1, caminho2):
    ...
    pred1, pred2, pred3, pred4 = predicts(caminho1, caminho2)

    face, vgg = verifyFace(pred1, pred2, pred3, pred4)
...
caminho1 = '/home/co/Documentos/vgg-face/face-data/train/manyu/4.jpg'
caminho2 = '/home/co/Documentos/vgg-face/face-data/train/pig/55.jpg'
